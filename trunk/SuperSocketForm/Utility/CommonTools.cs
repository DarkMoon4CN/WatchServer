...
namespace SuperSocketForm.Utility
{
    ...
    {     
        ...
        public static void Cipher(ref Byte[] input, Int32 length = 0)
        {
	        ...
	        {
                Cipher(ref inArr, true);
	        }
        }

        public static void Cipher(ref Byte[] input, Boolean iState)
        {
        ...
        public static Byte[] md5(Byte[] str)
            {
                ...
                {
                    String hash = GetMd5Hash(md5Hash, System.Text.Encoding.Default.GetString(str).TrimEnd('\0'));
                    hash = hash.ToLower();
